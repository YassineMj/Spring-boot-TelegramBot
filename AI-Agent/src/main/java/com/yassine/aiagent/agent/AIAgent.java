package com.yassine.aiagent.agent;
...
public class AIAgent {
    ...
    public AIAgent(ChatClient.Builder builder, ChatMemory memory,  ToolCallbackProvider tools) {
        Arrays.stream(tools.getToolCallbacks()).forEach(toolCallback -> {
            System.out.println("----------------------");
            System.out.println("name : " + toolCallback.getToolDefinition().name());
        ...
        this.chatClient = builder
                .defaultSystem("""
                        ...
                        Si aucun contexte n'est fourni, répond avec JE NE SAIS PAS CETTE QUESTION N'EST PAS DANS LE CONTEXTE         
                        """)
